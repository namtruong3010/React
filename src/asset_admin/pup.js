    ...
    for (var t = {
            ...
            vendors: {
                default: {
                    ...
                    getEditor: function() {
                        ...
                        return document.querySelectorAll('.hello')
                    }
                },
                bbpress: {
                    settings: {
                ...
                nodebb: {
                    ...
                    callback: function() {
                        for (var t = document.querySelectorAll(".btn-toolbar .img-upload-btn"), e = 0; e < t.length; e++) t[e].parentNode.removeChild(t[e])
                    }
                },
                phpbb: {
                    settings: {
                    ...
                    check: "phpbb",
                    getEditor: function() {
                        if ("undefined" != typeof form_name && "undefined" != typeof text_name) return document.forms[form_name].elements[text_name]
                    }
                },
                proboards: {
                    settings: {
                ...
                XF2: {
                    ...
                    getEditorFn: function(t) {
                        var e = ".js-editor";
                        return "string" == typeof t && (e = this.getEditorSel(t)), XF.getEditorInContainer($(e))
                    },
                    ...
                    editorValue: function(t, e) {
                        var i = "<p><br></p>",
                            ...
                            r = s.ed[n[0]];
                        if ("string" != typeof t) {
                            if (void 0 === r[n[1]]) var o = this.getBbCode(r);
                            else o = r[n[1]]();
                ...
                if (t) {
                    if (!document.getElementById(this.ns.pluginStyle) && this.settings.css) {
                        var o = document.createElement("style"),
                            a = this.settings.css;
                        a = this.appyTemplate(a), o.type = "text/css", o.innerHTML = a.replace(/%p/g, "." + this.ns.plugin), o.setAttribute("id", this.ns.pluginStyle), document.body.appendChild(o)
                    }
                    ...
                    for (r = 0; r < t.length; r++)
                        if (!t[r].getAttribute(this.ns.dataPluginTarget)) {
                            var d = i || t[r];
                            d.setAttribute(this.ns.dataPlugin, "sibling"), d.insertAdjacentHTML({
                                before: "beforebegin",
                                after: "afterend"
            ...
            openPopup: function(t) {
                if ("string" == typeof t) {
                    ...
                    if (void 0 === this.popups && (this.popups = {}), void 0 === this.popups[t]) {
                        ...
                        this.popups[t].window = window.open(this.settings.url, t, "width=" + s.w + ",height=" + s.h + ",top=" + o.t + ",left=" + o.l), this.popups[t].timer = window.setInterval(function() {
            ...
            liveBind: function(t, e, i) {
                document.addEventListener(e, function(e) {
                    ...
                    if (s) {
                        for (var n = e.target, r = -1; n && -1 === (r = Array.prototype.indexOf.call(s, n));) n = n.parentElement;
            ...
            prepare: function() {
                var t = this;
                this.ns.dataPlugin = "data-" + this.ns.plugin, this.ns.dataPluginId = this.ns.dataPlugin + "-id", this.ns.dataPluginTrigger = this.ns.dataPlugin + "-trigger", this.ns.dataPluginTarget = this.ns.dataPlugin + "-target", this.ns.pluginStyle = this.ns.plugin + "-style", this.ns.selDataPluginTrigger = "[" + this.ns.dataPluginTrigger + "]";
                ...
                var i = 0;
                for (var s in this.settings = {}, this.defaultSettings) {
                    var n = e && e.dataset[s] ? e.dataset[s] : this.defaultSettings[s];
                    "1" !== n && "0" !== n || (n = "true" == n), "string" == typeof n && this.classProps.indexOf(s.replace(/Class$/, "")) > -1 && (i = 1), this.settings[s] = n
                }
                if ("auto" == this.settings.vendor)
                    for (var s in this.settings.vendor = "default", this.settings.fitEditor = 0, this.vendors)
                ...
                if (o.settings)
                    for (var s in o.settings) e && e.dataset.hasOwnProperty(s) || (this.settings[s] = o.settings[s]);
                else
                    for (var s in o.settings = {}, this.defaultSettings) - 1 == r.indexOf(s) && (o.settings[s] = this.defaultSettings[s]);
                if ("default" !== this.settings.vendor)
                    if (o.settings.hasOwnProperty("fitEditor") || e.dataset.hasOwnProperty("fitEditor") || (this.settings.fitEditor = 1), this.settings.fitEditor) i = !o.settings.css;
                    else {
                    ...
                    this.settings.css = this.settings.css.replace("%defaultCSS", this.defaultSettings.css), o.settings.extracss && this.settings.css && (this.settings.css += o.settings.extracss);
                    var a = this.settings.palette.split(",");
                    a.length > 1 ? this.palette = a : this.palettes.hasOwnProperty(a) || (this.settings.palette = "default"), this.palette || (this.palette = (this.settings.fitEditor && o.palettes && o.palettes[this.settings.palette] ? o : this).palettes[this.settings.palette])
                }
                ...
                this.settings.langString = "Lấy link ảnh";
                var g = c in this.l10n ? c : c.substring(0, 2) in this.l10n ? c.substring(0, 2) : null;
                g && (this.settings.langString = this.l10n[g]);
                var h = document.createElement("a");
                h.href = this.settings.url, this.originUrlPattern = "^" + (h.protocol + "//" + h.hostname).replace(/\./g, "\\.").replace(/\//g, "\\/") + "$";
                ...
                if (this.settings.observe) {
                    ...
                    this.settings.observeCache && (b += ":not([" + this.ns.dataPlugin + "])"), this.liveBind(b, "click", function(e) {
                ...
                this.liveBind(this.ns.selDataPluginTrigger, "click", function(e) {
                    ...
                    if (s.test(i.origin) || void 0 !== i.data.id && void 0 !== i.data.message) {
                        ...
                        if (n && i.source === t.popups[n].window)
                            if (i.data.requestAction && t.hasOwnProperty(i.data.requestAction)) t[i.data.requestAction](n);
                            else {
                                var r;
        ...
        }, e = ["WoltLab", "XF1"], i = 0; i < e.length; i++) t.vendors[e[i]] = Object.assign(Object.assign({}, t.vendors.redactor2), t.vendors[e[i]]);
    t.prepare()
})();