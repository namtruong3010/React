...
export default function ListCategory({category,onDelete}) {
    const Delete = (id) => {
      swal({
          title: "Thông báo",
              ...
              <div className="card card-custom gutter-b example example-compact">
                ...
                <div className="card-body">
                  <table className="table table-bordered">
                    ...
                    <tbody>
                        { category.map(({id,name,description,image},key) => (
                           <tr key={key}>
                             <td>{id} </td>
                             <td> {name}  </td>
                             <td> {description}  </td>
                             <td> <img src={image} width="50px" />  </td>
                             <td> <Link className="col-md-1" to={`/admin/edit/category/${id}`} ><i className="fa fa-edit"></i></Link> 
