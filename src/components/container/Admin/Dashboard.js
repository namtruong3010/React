...
export default function Dashboard() {
    return (
        ...
        <div className=" container-fluid  d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <a href="#" className="btn btn-light-warning font-weight-bolder btn-sm">
                Add New
            </a>
            {/*end::Actions*/}
            </div>
            ...
            {/*end::Actions*/}
            {/*begin::Daterange*/}
            <a href="#" className="btn btn-sm btn-light font-weight-bold mr-2" id="kt_dashboard_daterangepicker" data-toggle="tooltip" data-placement="left" data-original-title="Select dashboard daterange">
                <span className="text-muted font-size-base font-weight-bold mr-2" id="kt_dashboard_daterangepicker_title">Today:</span>
                <span className="text-primary font-size-base font-weight-bolder" id="kt_dashboard_daterangepicker_date">Aug 4</span>
            </a>
            {/*end::Daterange*/}
            {/*begin::Dropdowns*/}
            <div className="dropdown dropdown-inline" data-toggle="tooltip" data-placement="left" data-original-title="Quick actions">
        ...
        <div className=" container ">
            ...
            <div className="col-xl-3">
                ...
                <div className="card-body">
                    <span className="svg-icon svg-icon-2x svg-icon-success">{/*begin::Svg Icon | path:assets/media/svg/icons/Communication/Mail-opened.svg*/}<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
            ...
            <div className="col-xl-3">
                ...
                {/*begin::ody*/}
                <div className="card-body">
                    <span className="svg-icon svg-icon-2x svg-icon-danger">{/*begin::Svg Icon | path:assets/media/svg/icons/Communication/Group.svg*/}<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
            ...
            <div className="col-xl-3">
                ...
                {/*begin::Body*/}
                <div className="card-body">
                    <span className="svg-icon svg-icon-2x svg-icon-info">{/*begin::Svg Icon | path:assets/media/svg/icons/Media/Equalizer.svg*/}<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                        <rect x={0} y={0} width={24} height={24} />
            ...
            <div className="col-xl-3">
                ...
                {/*begin::Body*/}
                <div className="card-body">
                    <span className="svg-icon svg-icon-2x svg-icon-warning">{/*begin::Svg Icon | path:assets/media/svg/icons/Communication/Group-chat.svg*/}<svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
                        <rect x={0} y={0} width={24} height={24} />
